window.ModelViewerPluginFile = document.currentScript.src.substring(0, document.currentScript.src.lastIndexOf('/'))

window.ModelViewerPlugin = () => {
    ...
    function addStyleSheet(name){
        ...
        link.rel  = 'stylesheet'
        link.type = 'text/css'
        link.href = `${window.ModelViewerPluginFile}/${name}.css`
        link.media = 'all'
